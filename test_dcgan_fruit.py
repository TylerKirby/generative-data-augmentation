...
if __name__ == '__main__':
    ...
    with open('dcgan_generator_architecture_v1.json', 'r') as f:
        generator = tf.keras.models.model_from_json(f.read())
    generator.load_weights('dcgan_generator_weights_v1.h5')

    generated_images = (generator.predict(noise) * 255).astype(int)
